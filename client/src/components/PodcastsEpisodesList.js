...
var PodCastEpisodesListComponent = React.createClass({
  ...
  loadFeeds: function() {
    ...
    doRequest('https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&q=' + encodeURIComponent(this.props.link) +'&output=json_xml&v=1.0&callback=' + callbackName);
  },
